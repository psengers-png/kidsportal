...
"Dit moet een oningekleurde lijntekening zijn (coloring book page). "
"Alleen zwarte outlines op een witte achtergrond. "
"Er mag absoluut geen kleur in de afbeelding zitten. "
"Geen grijs, geen schaduw, geen verloop, geen vulling. "
"Eenvoudige vormen, dikke lijnen, minimale details. "
"Vector line art, zoals een printbare kleurplaat voor kinderen."
            )
